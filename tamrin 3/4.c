...
if (PINA.0==0) target=0;
if (PINA.1==0) target=1;
if (PINA.2==0) target=2;
if (PINA.3==0) target=3;
if (PINA.4==0) target=4;
if (PINB.0==0) target=0;
if (PINB.1==0) target=1;
if (PINB.2==0) target=2;
if (PINB.3==0) target=3;
if (PINB.4==0) target=4;
}
